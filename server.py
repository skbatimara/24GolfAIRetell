...
# twilio_client.register_phone_agent("+16473722134", os.environ['RETELL_AGENT_ID'])
...
async def handle_twilio_voice_webhook(request: Request, agent_id_path: str):
    ...
    try:
        ...
        if call_response.call_detail:
            print("he")
            os.environ[call_response.call_detail.call_id]=post_data['Caller']
            # os.environ['all_response.call_detail.call_id']="post_data['Caller']"
            # x=os.environ[call_response.call_detail.call_id]
            # print(x)
